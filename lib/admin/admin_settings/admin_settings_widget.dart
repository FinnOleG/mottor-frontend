...
import '/components/team_member_action_sheet_widget.dart';
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        24.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  'Eine Übersicht über deine Mitarbeiter & Daten',
                                                          ...
                                                          child: StreamBuilder<
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              List<DrivingInstructionsRecord>
                                                                  listViewDrivingInstructionsRecordList =
                                                                  snapshot
                                                                      .data!;
                                                              return ListView
                                                                  .builder(
                                                                ...
                                                                itemBuilder:
                                                                    (context,
                                                                        listViewIndex) {
                                                                  final listViewDrivingInstructionsRecord =
                                                                      listViewDrivingInstructionsRecordList[
                                                                          listViewIndex];
                                                                  return Padding(
                                                                    padding: const EdgeInsetsDirectional
                                                                            ...
                                                                            Expanded(
                                                                              child: Padding(
                                                                                ...
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    Text(
                                                                                      listViewDrivingInstructionsRecord.name,
                                                                                  ...
                                                                                  child: InkWell(
                                                                                    ...
                                                                                    onTap: () async {
                                                                                      context.pushNamed(
                                                                                        'createNewTemplate',
                                                                                        queryParameters: {
                                                                                          'drivingInstruction': serializeParam(
                                                                                            listViewDrivingInstructionsRecord.reference,
                                                                                ...
                                                                                builder: (context) {
                                                                                  return GestureDetector(
                                                                                    ...
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: TeamMemberActionSheetWidget(
                                                                                        memberID: listViewUsersRecord.reference,
                                                                                      ),
                                                                                    ),
                                                                                  );
                                                                                },
