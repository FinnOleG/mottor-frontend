...
export 'admin_feed_model.dart';

class AdminFeedWidget extends StatefulWidget {
  const AdminFeedWidget({super.key});

  @override
  _AdminFeedWidgetState createState() => _AdminFeedWidgetState();
}

class _AdminFeedWidgetState extends State<AdminFeedWidget> {
  late AdminFeedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminFeedModel());
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: Visibility(
          visible: MediaQuery.sizeOf(context).width > 400.0,
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            24.0, 4.0, 0.0, 0.0),
                                        child: Text(
                                          'Eine Übersicht über deine Posts.',
                          ...
                          if (responsiveVisibility(
                            ...
                            StreamBuilder<List<PostsRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<PostsRecord> mobileViewPostsRecordList =
                                    snapshot.data!;
                                ...
                                return ListView.separated(
                                  ...
                                  itemCount: mobileViewPostsRecordList.length,
                                      ...
                                      return Padding(
                                        ...
                                        child: StreamBuilder<List<ImageRecord>>(
                                          stream: queryImageRecord(
                                            parent:
                                                mobileViewPostsRecord.reference,
                                          ),
                                          builder: (context, snapshot) {
                                            // Customize what your widget looks like when it's loading.
                                            if (!snapshot.hasData) {
                                            ...
                                            return Container(
                                              ...
                                              child: ImageSelectionWidget(
                                                key: Key(
                                                    'Keyqmq_${mobileViewIndex}_of_${mobileViewPostsRecordList.length}'),
                                                isNet:
                                                    listContainerImageRecordList
                                                        .first.isNetImage,
                                                u2Net:
